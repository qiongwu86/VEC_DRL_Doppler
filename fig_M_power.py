...
plt.plot(x, ddpg_sum_power, color='#1f77b4', label='DDPG' )
plt.plot(x, GD_local_sum_power, color='salmon', label='Greedy_Local',lw=1)
plt.plot(x, GD_offload_sum_power, color='darkred',label='Greedy_Offload',lw=1)
